...
using GameMasterEnterprise.API.Models;
...
namespace GameMasterEnterprise.API.Controllers
{
    //[Authorize]
    [ApiVersion("1.0")]
    [Route("autenticate")]
    public class AutenticacaoController : HomeController
    {
        ...
        public AutenticacaoController(IMapper mapper,INotificador notificador,
